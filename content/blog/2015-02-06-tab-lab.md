...
<figure class="mt-8">
    <div class="device device--phone device--phone--landscape">
      <div class="device-screen">
        <img src="{{ site.assets-base-url }}images/articles/intro-tablab/music-small.jpg" alt="tablab.io music on small screens" class="device-screen-img">
      </div>
    </div>
    <figcaption>
