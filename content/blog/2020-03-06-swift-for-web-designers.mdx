...
Despite its quirks and unfamiliarity, I am already a fan of SwiftUI. Because in many ways it feels like the tools I am already using on the web, I can absolutely see myself building out the UI (and more) of an entire app with this in a matter of weeks. Who knows, maybe I'll get something in the App Store this year?